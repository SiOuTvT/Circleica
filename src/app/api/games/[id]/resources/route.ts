...
export async function GET(
  ...
  try {
    ...
    const formatted = resources.map(r => ({
      ...
      platform: Array.isArray(r.platform) ? r.platform as string[] : [],
      language: Array.isArray(r.language) ? r.language as string[] : [],
      runType: Array.isArray(r.runType) ? r.runType as string[] : [],
      resourceContent: Array.isArray(r.resourceContent) ? r.resourceContent as string[] : [],
  ...
  try {
    ...
    return NextResponse.json({
      resource: {
        ...
        platform: Array.isArray(resource.platform) ? resource.platform as string[] : [],
        language: Array.isArray(resource.language) ? resource.language as string[] : [],
        runType: Array.isArray(resource.runType) ? resource.runType as string[] : [],
        resourceContent: Array.isArray(resource.resourceContent) ? resource.resourceContent as string[] : [],
