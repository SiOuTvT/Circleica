      ...
      <div className="flex items-center gap-2">
        <div className="relative flex-1 max-w-xs">
          ...
          <input
            ...
            className="rounded-xl border border-input bg-transparent pl-9 pr-3 py-2.5 text-sm text-foreground placeholder:text-muted-foreground outline-none transition-colors focus:border-ring transition-all w-full"
          />
        </div>
      ...
      <div className="flex items-end gap-3 flex-wrap">
        <div className="space-y-1">
          ...
          <input
            ...
            className="block w-40 rounded-lg border border-input bg-transparent px-2.5 py-2 text-[15px] text-foreground outline-none transition-colors focus:border-ring"
          />
        </div>
        ...
        <div className="space-y-1">
          ...
          <select
            ...
            className="block w-36 rounded-lg border border-input bg-transparent px-2.5 py-2 text-[15px] text-foreground outline-none transition-colors focus:border-ring"
          >
