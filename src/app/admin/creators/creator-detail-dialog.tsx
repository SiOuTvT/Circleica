              ...
              <div className="flex flex-wrap items-center gap-2 mt-2">
                ...
                {creator.vndbId && (
                  <a
                    ...
                    className="inline-flex items-center gap-1 text-xs font-medium text-muted-foreground bg-secondary/80 rounded-full px-2.5 py-1.5 ring-1 ring-border hover:ring-foreground/10 hover:text-foreground transition duration-150 ease-in-out"
                  >
