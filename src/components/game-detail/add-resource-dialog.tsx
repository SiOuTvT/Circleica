              ...
              >
                ...
                <div>
                  ...
                  <input
                    ...
                    className={cn(
                      "w-full rounded-lg border border-input bg-transparent text-foreground px-3.5 py-2.5 text-[15px] outline-none transition-colors focus:border-ring",
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-lg border border-input bg-transparent text-foreground px-3.5 py-2.5 text-[15px] outline-none transition-colors focus:border-ring"
                    />
                  </div>
                  <div>
                    <label className="text-sm font-semibold text-foreground mb-1.5 block">
