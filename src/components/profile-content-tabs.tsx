      ...
      {showCreateFolder ? (
        <div className="rounded-xl bg-secondary/50 p-4 ring-1 ring-border">
          <input type="text" value={newFolderName} onChange={(e) => setNewFolderName(e.target.value)}
            placeholder="收藏夹名称" className="mb-3 w-full rounded-lg border border-input bg-transparent px-3 py-2.5 text-[15px] text-foreground outline-none transition-colors focus:border-ring"
