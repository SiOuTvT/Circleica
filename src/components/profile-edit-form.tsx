  ...
  return (
    <form onSubmit={handleSubmit} className="w-full">
      ...
      <div className="flex flex-col lg:flex-row items-stretch min-w-0 gap-0">
        ...
        {/* 右栏：信息 + 安全 */}
        <main className="w-full lg:w-[calc(100%-396px)] lg:shrink-0 flex flex-col lg:ml-6 min-w-0 order-2 lg:order-none gap-6 sm:gap-8">
          {/* 基本信息 */}
          <section className="rounded-2xl bg-card border border-border p-5 sm:p-9 space-y-7">
            ...
            <div>
              <label htmlFor={usernameId} className="block mb-2 text-sm font-medium text-muted-foreground">
                用户名
              </label>
              <div className="flex items-center gap-3 rounded-xl border-2 border-input bg-transparent px-4 py-4 transition-[color,background-color,border-color,text-decoration-color,fill,stroke,opacity,box-shadow,transform,filter,backdrop-filter,border-radius] duration-300 ease-out focus-within:rounded-none focus-within:border-primary">
            ...
            <div>
              <label className="block mb-2 text-sm font-medium text-muted-foreground">邮箱</label>
              <div className="flex items-center gap-3 rounded-xl border-2 border-input bg-transparent px-4 py-4">
                ...
                <span className="shrink-0 text-xs text-muted-foreground">登录与通知</span>
              </div>
            </div>

            <div>
              <label htmlFor={bioId} className="block mb-2 text-sm font-medium text-muted-foreground">
                个人简介
              </label>
              <div className="rounded-xl border-2 border-input bg-transparent px-4 py-4 transition-[color,background-color,border-color,text-decoration-color,fill,stroke,opacity,box-shadow,transform,filter,backdrop-filter,border-radius] duration-300 ease-out focus-within:rounded-none focus-within:border-primary">
                <Textarea
                  id={bioId}
                  variant="ghost"
                  value={bio}
                  ...
                  maxLength={200}
                  rows={4}
                  className="resize-none px-0 py-0 text-base"
                />
          ...
          <section className="rounded-2xl bg-card border border-border p-5 sm:p-7 lg:p-9">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xs text-muted-foreground">不想改的话留空就好~</span>
            </div>
          ...
          {/* 保存 */}
          <div className="rounded-2xl bg-card border border-border p-7 sm:p-9">
            <button
              type="submit"
              disabled={saving}
              className="flex w-full items-center justify-center gap-2 rounded-xl bg-primary py-4 text-base font-semibold text-primary-foreground transition-opacity hover:opacity-90 disabled:opacity-60"
            >
