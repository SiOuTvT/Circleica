...
export function RichTextEditor({
  ...
  return (
    <div className={cn("rounded-xl border-2 border-border bg-card overflow-hidden transition-[color,background-color,border-color,text-decoration-color,fill,stroke,opacity,box-shadow,transform,filter,backdrop-filter,border-radius] duration-300 ease-out focus-within:rounded-none focus-within:border-primary", className)}>
      {/* 工具栏 */}
