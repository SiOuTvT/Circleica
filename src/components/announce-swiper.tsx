    ...
    >
      ...
      <div className="absolute inset-0 z-[2] flex flex-col justify-end p-2.5 sm:p-3 lg:p-3.5 cursor-pointer">
        ...
        >
          ...
          {/* 查看详情（手机端隐藏） */}
          <span
            className="hidden sm:inline-flex items-center gap-1 text-xs font-medium text-white transition-colors duration-200 hover:text-primary hover:underline underline-offset-4 decoration-1"
          >
            查看详情
