...
export function HomeRandomDiscover() {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="rounded-xl bg-card border border-border px-5 py-3.5 text-center shadow-sm hover:bg-accent/50 hover:border-border/60 transition-colors disabled:opacity-50 cursor-pointer flex flex-col items-center justify-center gap-1" data-ripple
      title="随机游戏"
