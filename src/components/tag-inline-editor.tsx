    ...
    <div className="rounded-xl bg-secondary/50 p-4 space-y-3 ring-1 ring-border">
      <div className="flex gap-2">
        ...
        <input
          ...
          title="排序值（小的在前）"
          className="w-16 shrink-0 rounded-lg border-2 border-input bg-transparent px-2 py-2.5 text-xs text-foreground outline-none transition-[border-radius,border-color] duration-300 ease-out focus:rounded-none focus:border-primary"
        />
        <button
          type="button"
