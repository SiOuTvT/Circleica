 ...
 *
 * 约定（与产品口径一致）：
 *  - 14px / 字重 500 / 前景实色（与卡片标题同档），悬停变主色并加下划线；
...
export const PERSON_LINK_CLASS =
  "text-[14px] font-medium text-foreground hover:text-primary hover:underline underline-offset-4 decoration-1 transition-colors duration-200"
