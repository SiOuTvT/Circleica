...
export function Breadcrumb() {
  ...
  if (specialCrumbs !== null) {
    ...
    return (
      <nav className="my-3 sm:my-7 flex items-center gap-1.5 overflow-x-auto whitespace-nowrap text-sm sm:text-[15px] text-muted-foreground leading-none" aria-label="面包屑导航">
        <Link
          href="/"
