...
export function Breadcrumb() {
  ...
  if (specialCrumbs !== null) {
    ...
    return (
      <nav className="my-4 sm:my-5 lg:my-6 flex items-center gap-1.5 overflow-x-auto whitespace-nowrap text-sm sm:text-[15px] text-muted-foreground leading-none" aria-label="面包屑导航">
        <Link
          href="/"
