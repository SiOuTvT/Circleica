...
export const GameCard = memo(function GameCard({
  ...
  return (
    <Link
      ...
      className="game-card group relative flex h-full flex-col overflow-hidden rounded-2xl bg-card ring-1 ring-border transition duration-300  hover:ring-foreground/10 hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
      onClick={(e) => {
        try {
    ...
    >
      ...
      <div className="game-card-body flex flex-1 flex-col overflow-hidden px-2.5 pb-2.5 pt-2.5 sm:px-3.5 sm:pb-3 sm:pt-3">
        ...
        <h3 title={game.title} className="game-card-title text-[20px] font-bold leading-snug line-clamp-2 text-foreground">
          <Cjk>{game.title}</Cjk>
        </h3>
