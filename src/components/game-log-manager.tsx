    ...
    <Card size="comfortable" radius="xl" className="space-y-3">
      ...
      <form onSubmit={add} className="flex gap-2">
        ...
        <button type="submit" disabled={adding || !content.trim()}
          className="flex items-center gap-1.5 rounded-xl bg-secondary px-4 py-2 text-sm text-foreground transition duration-150 ease-in-out hover:bg-secondary disabled:opacity-50">
