              ...
              <div>
                ...
                <form onSubmit={handleSubmitComment} className="flex gap-2 items-center">
                  ...
                  <input ref={commentInputRef} value={commentText} onChange={(e) => setCommentText(e.target.value)} placeholder="写下评论…"
                    className="flex-1 rounded-xl border border-input bg-transparent px-4 py-3.5 text-[15px] text-foreground placeholder:text-muted-foreground outline-none transition-[border-radius,border-color] duration-300 ease-out focus:rounded-none focus:border-ring min-h-[48px]" />
