    ...
    <div className="fixed inset-0 z-50 touch-none flex items-center justify-center bg-black/80 backdrop-blur-sm">
      <div className="relative mx-4 w-full max-w-lg rounded-2xl p-5 shadow-4" style={{ background: "hsl(var(--card))", border: "1px solid hsl(var(--border))" }}>
        ...
        <div className="mt-5 flex items-center justify-end gap-2">
          ...
          <button type="button" onClick={handleConfirm} disabled={isCropping} className="flex items-center gap-1.5 rounded-xl px-5 py-2 text-sm font-semibold text-primary-foreground transition duration-150 ease-in-out hover:opacity-90 disabled:opacity-60 bg-primary">
