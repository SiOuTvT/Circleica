/**
 * VNDB 共享常量
 * vndb-client.ts（浏览器端）和 vndb.ts（服务器端）共用的数据
 */

/** 已知的 producer ID 列表（用于随机获取创作者） */
export const KNOWN_PRODUCER_IDS = [
...
/** Staff 搜索关键词（用于随机获取创作者） */
export const STAFF_SEARCH_TERMS = [
  "あ", "か", "さ", "た", "な", "は", "ma", "ら", "わ",
...
/** 热门游戏搜索词（用于随机获取角色） */
export const POPULAR_VN_SEARCHES = [
  "fate", "clannad", "steins", "muv-luv", "grisaia",
  "little busters", "rewrite", "angel beats", "danganronpa", "zero escape",
]
