...
| 要理解"为什么这样设计" | [ARCHITECTURE](ARCHITECTURE.md) | 分层、关键模块、部署模型、上线自查 |
| 要调接口 / 做前端 | [API_REFERENCE](API_REFERENCE.md) | 响应格式、鉴权、分页、错误码、路由总览 |
...
- **Reference**：[API_REFERENCE](API_REFERENCE.md)
- **How-to**：（待补 `how-to/`）
